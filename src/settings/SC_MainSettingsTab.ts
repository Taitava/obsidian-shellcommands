        ...
        if (this.plugin.settings.show_installation_warnings) {
            switch (getObsidianInstallationType()) {
                case "Flatpak": {
                    ...
                    calloutContent.createEl("p").innerHTML = "When Obsidian is installed using Flatpak, shell commands are executed in an isolated environment, which may cause some commands not to work. <a href=\"https://publish.obsidian.md/shellcommands/Flatpak+installation\">Read more</a>.";
                    createCallout(
                        containerElement,
                        "warning",
