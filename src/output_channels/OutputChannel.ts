/**
 * Designed additional values for later: "statusbar" | "modal" | "current-file-top" | "current-file-bottom" | "specific-file-top" | "specific-file-bottom" | "specific-file-caret" (if possible)
